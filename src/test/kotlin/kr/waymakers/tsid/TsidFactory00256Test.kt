...
class TsidFactory00256Test : TsidFactory00000Test() {
	@Test
	fun testGetTsid256() {
	...
	@Test
	fun testGetTsidString256WithNode() {
		val startTime = System.currentTimeMillis()
	...
	companion object {
		private const val NODE_BITS = 8
		private const val COUNTER_BITS = 14
